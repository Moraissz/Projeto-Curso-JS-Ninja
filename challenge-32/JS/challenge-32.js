  ...
  */
  function app() {
    ...
    function saveValueOnServer() {
      ...
      ajaxPostCar.onreadystatechange = function () {
        if (ajaxPostCar.readyState === 4) {
          console.log(ajaxPostCar.responseText);
        }
      }
    }
    ...
    function addValuesOnTable() {
      ...
      $table.get().appendChild($fragment);
      addListenerOnButtonRemove()
    }
    ...
    function removeLineFromTable() {
      ...
      $table.get().removeChild(LineToBeRemoved);
    }
